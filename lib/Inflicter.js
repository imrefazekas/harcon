...
inflicter.entityShifted = function ( component, callback ) {
	let self = this
	return new Promise( (resolve, reject) => {
...
inflicter.firestarter = function ( name, callback ) {
	let self = this
	return new Promise( function (resolve, reject) {
		let fs = self.barrel.firestarter( name )
		Proback.returner( !fs ? new Error('No such entity exists') : null, fs, callback, resolve, reject )
	} )
}
...
inflicter.listener = function ( name, callback ) {
	...
	return new Promise( function (resolve, reject) {
		...
		Proback.returner( !listener ? new Error('No such entity exists') : null, listener, callback, resolve, reject )
	} )
}
