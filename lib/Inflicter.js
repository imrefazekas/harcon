...
inflicter.addicts = function( object, options ){
	...
	if(this.logger.verbose)
		this.logger.verbose( 'Object-based component published', object.name, object.context, object.division );
...
inflicter.addict = function( name, eventName, fn, division ){
	...
	if(this.logger.verbose)
		this.logger.verbose( 'Function-based component published', name, eventName, division );
