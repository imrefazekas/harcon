...
function Firestormstarter ( config, barrel, object, blower, logger ) {
	...
	if (this.config.suppressing || !this.object.notify) {
	...
	if (this.config.suppressing || !this.object.erupt)
	...
	if (this.config.suppressing || !this.object.ignite)
	...
	if (this.config.suppressing || !this.object.shifted)
	...
	if (this.config.suppressing || !this.object.setTimeout) {
		this.timeoutRefs = []
	...
	if (this.config.suppressing || !this.object.setInterval) {
		this.intervalRefs = []
