...
module.exports = function (self) {
	return {
		...
		harconSiblingEntities: async function () {
			...
			if ( !presences[ this.firestarter.domain ] || presences[ this.firestarter.domain ][ this.firestarter.name ] )
				return { }

			return presences[ this.firestarter.domain ][ this.firestarter.name ]
		}
	}
}
