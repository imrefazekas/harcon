...
firestarter.burst = function ( comm, params ) {
	...
	return new Promise( async function (resolve, reject) {
		let newComm = comm.burst( externalID, flowID, self.division, self.name, division, event, callParams, Proback.handler(null, resolve, reject) )
...
firestarter.innerIgnite = function ( ) {
	...
	return new Promise( async function (resolve, reject) {
		let comm = Communication.newCommunication( null, flowId, externalId, self.division, self.name, division, event, params, Proback.handler(null, resolve, reject) )
