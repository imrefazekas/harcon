	...
	return new Promise( async (resolve, reject) => {
		...
		*/
		let requestFn = self.auditor ? function ( ...parameters ) {
			return self.burst( comm, Communication.MODE_REQUIRE, parameters )
		} : function ( ...parameters ) {
			let args = [ null, null, self.division ].concat( parameters )
			return self.burst( comm, Communication.MODE_REQUIRE, args )
		}
...
firestarter.burst = function ( comm, mode, params ) {
	...
	let isRequire = mode === Communication.MODE_REQUIRE
	return new Promise( async function (resolve, reject) {
		let newComm = comm.burst( externalID, flowID, self.division, self.name, self.barrel.nodeID, division, event, callParams, isRequire ? Proback.handler(null, resolve, reject) : null )
...
firestarter.innerIgnite = function ( ...parameters ) {
	...
	let isRequire = mode === Communication.MODE_REQUIRE
	return new Promise( async function (resolve, reject) {
		let comm = Communication.newCommunication( null, flowId, externalId, self.division, self.name, self.barrel.nodeID, division, event, params, isRequire ? Proback.handler(null, resolve, reject) : null )
