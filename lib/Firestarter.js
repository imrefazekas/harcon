...
firestarter.burst = function ( comm, params ) {
	...
	return new Promise( function (resolve, reject) {
		var newComm = comm.burst( externalID, self.division, self.name, division, event, callParams, self.callBacker( event, callback, resolve, reject ) )
...
firestarter.innerIgnite = function ( ) {
	...
	return new Promise( function (resolve, reject) {
		var comm = Communication.newCommunication( null, null, externalId, self.division, self.name, division, event, params, self.callBacker( event, callback, resolve, reject ) )
