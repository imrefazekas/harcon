...
barrel.init = function( systemName, logger, config, callback ){
	this.firestarters = [ ];
	this.warpers = {};
	...
	this.extendedInit( systemName, config, callback );
};

barrel.extendedInit = function( systemName, config, callback ){
	callback();
};
...
barrel.newDivision = function( division ){
};
