...
* @constructor
*/
function Communication (originalId, flowId, externalId, sourceDivision, source, division, event, params, responder, error, response) {
...
commPrototype.twist = function ( name, error, response ) {
	let comm = new Communication( this.id, this.flowId, this.externalId, this.sourceDivision, this.source, this.division, this.event, this.params, name, error, response )
	return comm
}
...
*/
commPrototype.burst = function ( externalID, flowID, sourceDivision, source, division, event, params ) {
	let comm = new Communication( null, flowID || this.flowId, externalID || this.externalId, sourceDivision, source, division || this.division, event, params )
...
exports.newCommunication = function ( originalId, flowId, externalId, sourceDivision, source, division, event, params, responder, error, response ) {
	...
	let c = new Communication( originalId, flowId, externalId, sourceDivision, source, division, event, params, responder, error, response )
	c.valve = valve
	return c
}

exports.importCommunication = function ( obj ) {
	let c = new Communication( obj.originalId, obj.flowId, obj.externalId, obj.sourceDivision, obj.source, obj.division, obj.event, obj.params, obj.responder, obj.error, obj.response )
	c.id = obj.id
